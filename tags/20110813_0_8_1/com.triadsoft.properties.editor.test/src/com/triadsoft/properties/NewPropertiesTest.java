...
public class NewPropertiesTest extends TestCase {
	...
	public void testLanguage_es_AR_Properties() {
		...
		PropertiesFile props = new PropertiesFile();
		try {
			InputStream es_AR=new FileInputStream(PATH + "language.es_AR.properties");
			props.load(es_AR);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void testLanguage_en_US_Properties() {
		...
		PropertiesFile props = new PropertiesFile();
		try {
			InputStream en_US=new FileInputStream(PATH + "language.en_US.properties");
			props.load(en_US);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void testLanguage_short_Properties() {
		...
		PropertiesFile props = new PropertiesFile();
		try {
			InputStream en_US=new FileInputStream(PATH + "language_short.properties");
			props.load(en_US);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void test_en_GB_com_bannersIni() {
		...
		PropertiesFile props = new PropertiesFile();
		try {
			InputStream en_GB=new FileInputStream(PATH + "en-GB.com_banners.ini");
			props.load(en_GB);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void test_en_GB_com_contactIni() {
		...
		PropertiesFile props = new PropertiesFile();
		try {
			InputStream en_GB=new FileInputStream(PATH + "en-GB.com_contact.ini");
			props.load(en_GB);
		} catch (IOException e) {
			e.printStackTrace();
		}
