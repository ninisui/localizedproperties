...
public class WildcardPathTest extends TestCase {
	protected static final String FLEX_PROPERTIES = "/{root}/{lang}_{country}/{filename}.{fileextension}";
	protected static final String JAVA_PROPERTIES = "/{root}/{filename}(.{lang})2(_{country})1.{fileextension}";
	protected static final String WEB_PROPERTIES = "/{root}/{filename}(.{lang})2(_{country})1.{fileextension}";
	protected static final String JOOMLA_INI = "/{root}/{lang}-{country}/{lang}-{country}.{filename}.{fileextension}";
	...
	public void testJoomlaLanguageIniFiles() {
		WildCardPath2 wp = new WildCardPath2(JOOMLA_INI);
	...
	public void testFlex() {
		WildCardPath2 wp = new WildCardPath2(FLEX_PROPERTIES);
